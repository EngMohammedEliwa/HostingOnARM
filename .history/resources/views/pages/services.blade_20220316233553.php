            ...
            <div class="row services-boxes">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="item">
                         ...
                         <div class="make_btn_1">
                            <a class="make_a_1" href="{{route('buying')}}">Buy & Sell</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="item">
                         ...
                         <h2>Buying & Selling Other Scraps</h2>
                         <p>We also buy and sell selective Other scrap products that the company can provide later</p>
                         <div class="make_btn_1">
                            <a class="make_a_1" href="{{route('buying')}}">Buy & Sell</a>
                        </div>
                    </div>
