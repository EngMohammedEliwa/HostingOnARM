			...
			<div class="col-lg-12" style="padding: 0px;">
				<div class="container register">
					...
					<div class="form-group">
                        ...
                        <textarea class="input_2" name="message" placeholder="Your Message.."></textarea>
                    ...
                    <button name="sub" class="btn btn-blue">Register<i class="demo-icon icon-right-open"></i> </button>
