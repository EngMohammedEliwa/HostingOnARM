			...
			<div class="col-md-6">
				<div class="form">
                    ...
                    <form method="POST" action="{{ route('job') }}">
                        ...
                        <div class="flex_row"><label class="lab_1" for="mob">Enplyee Number : </label><input class="input_1" type="number" placeholder="Enter your number" name="Phone" required/></div>
                        <div class="flex_row"><label class="lab_1" for="msg">Message : </label><textarea  class="input_2" name="message" placeholder="Your Message.."></textarea></div>
