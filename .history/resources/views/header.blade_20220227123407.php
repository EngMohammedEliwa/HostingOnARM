<section class="header clearfix">
  ...
  <div class="menu-open "><img  src="images/menu.png"/></div>
      ...
      <ul>
		...
		<li><a class="current"  href="{{route('services') }}">Services </a></li>
		<li><a class="current"  href="{{route('products') }}">Products</a></li>
		<li><a class="current"  href="{{route('equipments') }}">Equipments</a></li>
		<li><a class="current" href="{{route('image-gallery') }}">Media</a></li>
