...
route::get('/', 'ControllerName@Indexpage')->name('home1');
...
Route::post('contact1', 'FormController@contactstore')->name('contact1');
Route::post('job', 'FormController@careerjob')->name('job');

route::get('News-And-Events', 'ControllerName@NewsAndEventspage')->name('news-and-events');
route::get('News', 'ControllerName@Newspage')->name('News');
route::get('Carear', 'ControllerName@carear')->name('carear');
route::get('Selling&Buying', 'ControllerName@buyingforme')->name('buying');
route::post('Order', 'ControllerName@Ordergforme')->name('order');
