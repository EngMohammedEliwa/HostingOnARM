<?php
namespace App\Http\Controllers\Formes\FormController;
use Illuminate\Support\Facades\Route;
use App\Http\Controllers\CustomAuthController;
use App\Http\Controllers\Formes\FormController;
...
Route::post('contact', 'FormController@contactstore')->name('contact');
